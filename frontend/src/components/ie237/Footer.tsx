...
const socials = [
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/company/iecameroun/posts/",
    icon: (
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61579459257934",
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/iecameroun?igsh=MWs5NmxiN3hqOGIxaw==",
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
  ...
  {
    name: "WhatsApp",
    href: "https://whatsapp.com/channel/0029Vb6li0x5PO0xML0vdS27",
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
  ...
  {
    name: "TikTok",
    href: "https://www.tiktok.com/@iecameroun",
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
    ...
    <footer id="contact" className="bg-background border-t border-border">
      <div className="container py-24 grid lg:grid-cols-12 gap-16">
        <div className="lg:col-span-7">
          ...
          <span className="mt-10 gap-4 text-sm font-medium"> Suivez-nous sur nos réseaux sociaux </span>
          {/* Réseaux sociaux */}
        ...
        <div className="lg:col-span-5 flex flex-col gap-12 text-sm">
          {/* Infos */}
          <div className="grid sm:grid-cols-2 gap-8">
            {[
              ...
              {
                title: "Statut",
                value: "Think Do Tank républicain",
                icon: (
                  <svg viewBox="0 0 24 24" className="w-4 h-4 fill-none stroke-current stroke-[1.5]">
              ...
              <div key={title} className="border-t border-border pt-5">
                <div className="flex items-center gap-2 text-accent text-[10px] uppercase tracking-[0.3em] font-medium">
                  {icon}
                  {title}
                </div>
                <div className="text-primary/80 mt-2">{value}</div>
              </div>
            ))}
          </div>
          <span className="gap-4 text-sm font-medium"> Liens Rapides </span>
          <div className="grid sm:grid-cols-2 gap-6">
            {[
              ...
              },
              {
                label: "Nos Missions",
                href: "/#missions",
                description: "Nos Missions",
              },
              {
                label: "Partenaires",
                href: "/#partenaires",
                description: "Les Partenaires avec qui nous collaborons",
              },
              {
                label: "Livrables",
                href: "/#livrables",
                description: "Nos Types de livrables",
              },
              {
                label: "Contact",
                href: "/#contact",
                description: "Engager le dialogue avec nous",
              },
              ...
              <NavHashLink
                ...
                smooth
                to={href}
                className="group pt-5 block transition-all"
              >
                <div className="text-primary/80 font-medium group-hover:text-accent transition-colors">
                  {label}
                </div>
      ...
      <div className="border-t border-border">
        <div className="container py-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground">
          <div className="flex items-center gap-2.5">
            <NavHashLink smooth to="/#top" className="flex flex-col sm:flex-row items-center sm:items-center gap-2 group">
              <img src="/logo.png" alt="Logo" className="w-[92px] object-contain" />
              <span className="font-display font-semibold tracking-tight text-primary text-sm sm:text-[20px] text-center sm:text-left">
